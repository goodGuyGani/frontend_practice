    ...
    this.fields.forEach(function (fld) {
      if (fld.hasAttribute("data-input-trigger")) {
        var input =
          ...
          /*fld.querySelector( '.cs-select' ) ||*/ fld.querySelector("select"); // assuming only radio and select elements (TODO: exclude multiple selects)
        if (!input) return;
    ...
    var self = this,
      onEndAnimationFn = function (ev) {
        ...
        if (self.isLastStep) {
          ...
          // Add the 'visible' class to reveal the element
